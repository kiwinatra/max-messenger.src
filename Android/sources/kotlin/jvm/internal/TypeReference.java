...
public final class TypeReference implements KType {
    ...
    private final String asString(boolean z) {
        ...
        if (Intrinsics.areEqual((Object) asString, (Object) i)) {
            return i;
        }
        if (Intrinsics.areEqual((Object) asString, (Object) i + '?')) {
            return i + '!';
    ...
    public int hashCode() {
        ...
        return Integer.hashCode(this.flags) + ((hashCode + (getClassifier().hashCode() * 31)) * 31);
    }
    ...
    public String toString() {
        return wj6.n(new StringBuilder(), asString(false), " (Kotlin reflection is not available)");
    }
