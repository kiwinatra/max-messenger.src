...
public abstract class AbstractList<E> extends AbstractCollection<E> implements List<E>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final void checkBoundsIndexes$kotlin_stdlib(int i, int i2, int i3) {
            if (i < 0 || i2 > i3) {
                StringBuilder n = a81.n("startIndex: ", i, ", endIndex: ", i2, ", size: ");
                n.append(i3);
                throw new IndexOutOfBoundsException(n.toString());
            } else if (i > i2) {
                throw new IllegalArgumentException(g63.h("startIndex: ", i, i2, " > endIndex: "));
            }
        }

        public final void checkElementIndex$kotlin_stdlib(int i, int i2) {
            if (i < 0 || i >= i2) {
                throw new IndexOutOfBoundsException(g63.h("index: ", i, i2, ", size: "));
            }
        }
        ...
        public final void checkRangeIndexes$kotlin_stdlib(int i, int i2, int i3) {
            if (i < 0 || i2 > i3) {
                StringBuilder n = a81.n("fromIndex: ", i, ", toIndex: ", i2, ", size: ");
                n.append(i3);
                throw new IndexOutOfBoundsException(n.toString());
            } else if (i > i2) {
                throw new IllegalArgumentException(g63.h("fromIndex: ", i, i2, " > toIndex: "));
            }
        }
        ...
        public final int newCapacity$kotlin_stdlib(int i, int i2) {
            ...
            int i4 = AbstractList.maxArraySize;
