...
public final class ListBuilder<E> extends AbstractMutableList<E> implements List<E>, RandomAccess, Serializable, KMutableList {
    ...
    public static final class BuilderSubList<E> extends AbstractMutableList<E> implements List<E>, RandomAccess, Serializable, KMutableList {
        ...
        public <T> T[] toArray(T[] tArr) {
            ...
            if (length2 < i) {
                E[] eArr = this.backing;
                int i2 = this.offset;
                return Arrays.copyOfRange(eArr, i2, i + i2, tArr.getClass());
            }
            E[] eArr2 = this.backing;
            int i3 = this.offset;
            ArraysKt___ArraysJvmKt.copyInto((T[]) eArr2, tArr, 0, i3, i + i3);
    ...
    private final void ensureCapacityInternal(int i) {
        if (i >= 0) {
            E[] eArr = this.backing;
            if (i > eArr.length) {
                this.backing = ListBuilderKt.copyOfUninitializedElements(this.backing, AbstractList.Companion.newCapacity$kotlin_stdlib(eArr.length, i));
                return;
            }
            return;
        }
    ...
    private final void insertAtInternal(int i, int i2) {
        ...
        E[] eArr = this.backing;
        ArraysKt___ArraysJvmKt.copyInto((T[]) eArr, (T[]) eArr, i + i2, i, this.length);
        this.length += i2;
    }
    ...
    public final E removeAtInternal(int i) {
        ...
        E[] eArr = this.backing;
        E e = eArr[i];
        ArraysKt___ArraysJvmKt.copyInto((T[]) eArr, (T[]) eArr, i, i + 1, this.length);
    ...
    public <T> T[] toArray(T[] tArr) {
        ...
        int i = this.length;
        if (length2 < i) {
            return Arrays.copyOfRange(this.backing, 0, i, tArr.getClass());
        }
        ArraysKt___ArraysJvmKt.copyInto((T[]) this.backing, tArr, 0, 0, i);
        return CollectionsKt.terminateCollectionToArray(this.length, tArr);
    }
