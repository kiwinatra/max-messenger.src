...
public final class MapBuilder<K, V> implements Map<K, V>, Serializable, KMutableMap {
    ...
    public static final class EntriesItr<K, V> extends Itr<K, V> implements Iterator<Map.Entry<K, V>>, KMutableIterator {
        ...
        public final void nextAppendString(StringBuilder sb) {
            if (getIndex$kotlin_stdlib() < getMap$kotlin_stdlib().length) {
                ...
                sb.append('=');
                Object obj2 = getMap$kotlin_stdlib().valuesArray[getLastIndex$kotlin_stdlib()];
    ...
    public static final class ValuesItr<K, V> extends Itr<K, V> implements Iterator<V>, KMutableIterator {
        ...
        public V next() {
            ...
            if (getIndex$kotlin_stdlib() < getMap$kotlin_stdlib().length) {
                ...
                setIndex$kotlin_stdlib(index$kotlin_stdlib + 1);
                setLastIndex$kotlin_stdlib(index$kotlin_stdlib);
                V v = getMap$kotlin_stdlib().valuesArray[getLastIndex$kotlin_stdlib()];
                initNext$kotlin_stdlib();
                return v;
            }
            throw new NoSuchElementException();
    ...
    private final int findValue(V v) {
        ...
        while (true) {
            ...
            if (this.presenceArray[i] >= 0 && Intrinsics.areEqual((Object) this.valuesArray[i], (Object) v)) {
                return i;
            }
        }
    }
    ...
    public final boolean containsEntry$kotlin_stdlib(Map.Entry<? extends K, ? extends V> entry) {
        ...
        return Intrinsics.areEqual((Object) this.valuesArray[findKey], (Object) entry.getValue());
    }
    ...
    public final boolean removeEntry$kotlin_stdlib(Map.Entry<? extends K, ? extends V> entry) {
        checkIsMutable$kotlin_stdlib();
        int findKey = findKey(entry.getKey());
        if (findKey < 0 || !Intrinsics.areEqual((Object) this.valuesArray[findKey], (Object) entry.getValue())) {
            return false;
        }
        removeEntryAt(findKey);
        return true;
