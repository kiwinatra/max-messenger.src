...
public final class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1520copyRFiDyg4$default(TimedValue timedValue, T t, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            t = timedValue.value;
        }
        if ((i & 2) != 0) {
        ...
        return timedValue.m1522copyRFiDyg4(t, j);
    }
    ...
    public final long m1521component2UwyO8pc() {
        return this.duration;
    }

    /* renamed from: copy-RFiDyg4  reason: not valid java name */
    public final TimedValue<T> m1522copyRFiDyg4(T t, long j) {
    ...
    public final long m1523getDurationUwyO8pc() {
        return this.duration;
    }
    ...
    public int hashCode() {
        T t = this.value;
        return Duration.m1381hashCodeimpl(this.duration) + ((t == null ? 0 : t.hashCode()) * 31);
    }
