...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return ((int) ((j3 >>> 32) ^ j3)) + (((((int) ULong.m197constructorimpl(j ^ ULong.m197constructorimpl(j >>> 32))) * 31) + ((int) ULong.m197constructorimpl(j2 ^ ULong.m197constructorimpl(j2 >>> 32)))) * 31);
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(ULong.m243toStringimpl(this.first));
            sb.append("..");
            sb.append(ULong.m243toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
