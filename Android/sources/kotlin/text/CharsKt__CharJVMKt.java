...
class CharsKt__CharJVMKt {
    ...
    public static int checkRadix(int i) {
        ...
        StringBuilder o = wj6.o(i, "radix ", " was not in valid range ");
    ...
    public static String titlecase(char c, Locale locale) {
        ...
        if (uppercase.length() <= 1) {
            return !Intrinsics.areEqual((Object) uppercase, (Object) String.valueOf(c).toUpperCase(Locale.ROOT)) ? uppercase : String.valueOf(Character.toTitleCase(c));
        }
        if (c == 329) {
            return uppercase;
        }
