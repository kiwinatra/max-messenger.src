...
class CharsKt__CharKt extends CharsKt__CharJVMKt {
    ...
    public static final char digitToChar(int i) {
        ...
        throw new IllegalArgumentException(a81.j(i, "Int ", " is not a decimal digit"));
    }
    ...
    public static final char digitToChar(int i, int i2) {
        if (2 > i2 || i2 >= 37) {
            throw new IllegalArgumentException(a81.j(i2, "Invalid radix: ", ". Valid radix values are in range 2..36"));
        } else if (i < 0 || i >= i2) {
            throw new IllegalArgumentException(g63.h("Digit ", i, i2, " does not represent a valid digit in radix "));
        } else {
