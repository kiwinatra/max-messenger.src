...
final class LZ4JavaUnsafeFastDecompressor extends LZ4FastDecompressor {
    ...
    public int decompress(byte[] bArr, int i, byte[] bArr2, int i2, int i3) {
        ...
        if (i3 != 0) {
            ...
            int i8 = i2;
            while (true) {
                byte a3 = gwf.a(i7, bArr);
                int i9 = i7 + 1;
                int i10 = (a3 & UByte.MAX_VALUE) >>> 4;
                if (i10 == 15) {
                    while (true) {
                        i5 = i9 + 1;
                        a2 = gwf.a(i9, bArr);
                ...
                if (i11 <= i12) {
                    ...
                    int i13 = i9 + i10;
                    short f = gwf.f(i13, bArr);
                    if (w0g.a == ByteOrder.BIG_ENDIAN) {
                        f = Short.reverseBytes(f);
                    }
                    i7 = i13 + 2;
                    int i14 = i11 - (f & UShort.MAX_VALUE);
                    if (i14 >= i2) {
                        int i15 = a3 & 15;
                        if (i15 == 15) {
                            while (true) {
