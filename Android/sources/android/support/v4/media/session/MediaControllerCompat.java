...
public final class MediaControllerCompat {
            ...
            public void onReceiveResult(int i, Bundle bundle) {
                ...
                if (mediaControllerImplApi21 != null && bundle != null) {
                    synchronized (mediaControllerImplApi21.mLock) {
                        ...
                        mediaControllerImplApi21.mSessionToken.setSession2Token(i8b.A(bundle));
    ...
    public static class TransportControlsApi21 extends TransportControls {
        ...
        public void setRepeatMode(int i) {
            sendCustomAction(MediaSessionCompat.ACTION_SET_REPEAT_MODE, wj6.g(i, MediaSessionCompat.ACTION_ARGUMENT_REPEAT_MODE));
        }

        public void setShuffleMode(int i) {
            sendCustomAction(MediaSessionCompat.ACTION_SET_SHUFFLE_MODE, wj6.g(i, MediaSessionCompat.ACTION_ARGUMENT_SHUFFLE_MODE));
        }
    ...
    public static MediaControllerCompat getMediaController(Activity activity) {
        Object tag = activity.getWindow().getDecorView().getTag(uic.media_controller_compat_view_tag);
    ...
    public static void setMediaController(Activity activity, MediaControllerCompat mediaControllerCompat) {
        activity.getWindow().getDecorView().setTag(uic.media_controller_compat_view_tag, mediaControllerCompat);
