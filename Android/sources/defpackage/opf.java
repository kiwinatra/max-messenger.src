...
public final class opf {
    ...
    public opf(boolean r6, java.lang.String r7, int r8, byte[] r9, int r10, int r11, byte[] r12) {
        /*
            r5 = this;
            r0 = 2
            r5.<init>()
        ...
        L_0x0065:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.opf.<init>(boolean, java.lang.String, int, byte[], int, int, byte[]):void");
    }
}
