...
public abstract class qv5 extends ViewGroup {
    public int a;
    public int b;
    public boolean c;
    public int o;
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            ...
            if (childAt.getVisibility() == 8) {
                childAt.setTag(agc.row_index_key, -1);
            } else {
                ...
                childAt.setTag(agc.row_index_key, Integer.valueOf(this.o - 1));
                int i11 = i8 + i5;
    ...
    public final void onMeasure(int i, int i2) {
        ...
        int i7 = (mode == Integer.MIN_VALUE || mode == 1073741824) ? size : IntCompanionObject.MAX_VALUE;
