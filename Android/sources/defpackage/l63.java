...
public final class l63 {
    ...
    public l63(int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        this.a = i;
        this.b = i2;
        this.c = i3;
        this.d = i4;
    ...
    public final boolean equals(java.lang.Object r5) {
        ...
        L_0x003d:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.l63.equals(java.lang.Object):boolean");
    }

    public final int hashCode() {
        return Integer.hashCode(this.g) + rae.h(this.f, rae.h(this.e, rae.h(-1, rae.h(this.d, rae.h(this.c, rae.h(this.b, Integer.hashCode(this.a) * 31, 31), 31), 31), 31), 31), 31);
    }
