...
public final class mv9 extends ibf {
    public final b32 c;
    ...
    public static final mv9 d(pf9 pf9) {
        int i;
        String str;
        if (!pf9.m()) {
            return null;
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (str != null) {
                if (Intrinsics.areEqual((Object) str, (Object) "chat")) {
                    b32 = b32.a(pf9);
                } else {
    ...
    public final boolean equals(Object obj) {
        ...
        return (obj instanceof mv9) && Intrinsics.areEqual((Object) this.c, (Object) ((mv9) obj).c);
    }
