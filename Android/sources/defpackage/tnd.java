...
public final class tnd {
    ...
    static {
        tnd tnd = new tnd(0, 0);
        new tnd(LongCompanionObject.MAX_VALUE, LongCompanionObject.MAX_VALUE);
        new tnd(LongCompanionObject.MAX_VALUE, 0);
        new tnd(0, LongCompanionObject.MAX_VALUE);
        c = tnd;
    }

    public tnd(long j, long j2) {
        boolean z = false;
        y64.g(j >= 0);
        y64.g(j2 >= 0 ? true : z);
        this.a = j;
    ...
    public final boolean equals(Object obj) {
        ...
        tnd tnd = (tnd) obj;
        return this.a == tnd.a && this.b == tnd.b;
    }
