...
public final class p3 implements sf5 {
    public final n3 a = new n3((String) null, 1);
    public final g1g b = new g1g(16384);
    public boolean c;
    ...
    public final int i(uf5 uf5, yl4 yl4) {
        g1g g1g = this.b;
        int read = ((gf4) uf5).read(g1g.a, 0, 16384);
        if (read == -1) {
            return -1;
        }
        g1g.H(0);
