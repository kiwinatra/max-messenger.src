...
public final class gf4 implements uf5 {
    ...
    static {
        gd5.a("goog.exo.extractor");
    }

    public gf4(b74 b74, long j, long j2) {
        this.b = b74;
        this.o = j;
        this.c = j2;
    }
    ...
    public final void b(int i) {
        ...
        byte[] bArr = this.v;
        if (i2 > bArr.length) {
            this.v = Arrays.copyOf(this.v, t0g.j(bArr.length * 2, 65536 + i2, i2 + 524288));
        }
    }
