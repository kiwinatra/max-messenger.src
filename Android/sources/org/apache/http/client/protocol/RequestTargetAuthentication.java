...
public class RequestTargetAuthentication implements HttpRequestInterceptor {
    ...
    public void process(HttpRequest httpRequest, HttpContext httpContext) throws HttpException, IOException {
        ...
        } else if (!httpRequest.containsHeader(AUTH.WWW_AUTH_RESP) && (authState = (AuthState) httpContext.getAttribute(ClientContext.TARGET_AUTH_STATE)) != null && (authScheme = authState.getAuthScheme()) != null) {
