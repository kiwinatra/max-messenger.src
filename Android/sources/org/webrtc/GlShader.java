...
public class GlShader {
    ...
    public GlShader(String str, String str2) {
        ...
        throw new RuntimeException(wj6.h(GLES20.glGetError(), "glCreateProgram() failed. GLES20 error: "));
    }
    ...
    private static int compileShader(int i, String str) {
        ...
        throw new RuntimeException(wj6.h(GLES20.glGetError(), "glCreateShader() failed. GLES20 error: "));
    }
    ...
    public int getAttribLocation(String str) {
        ...
        if (i != -1) {
            ...
            throw new RuntimeException(wj6.k("Could not locate '", str, "' in program"));
        }
    ...
    public int getUniformLocation(String str) {
        ...
        if (i != -1) {
            ...
            throw new RuntimeException(wj6.k("Could not locate uniform '", str, "' in program"));
        }
        throw new RuntimeException("The program has been released");
    }
