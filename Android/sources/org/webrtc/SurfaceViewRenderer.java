...
public class SurfaceViewRenderer extends SurfaceView implements SurfaceHolder.Callback, VideoSink, RendererCommon.RendererEvents {
    ...
    private void updateSurfaceSize() {
        ...
        StringBuilder n = a81.n("updateSurfaceSize. Layout size: ", width2, "x", height, ", frame size: ");
        g63.o(n, i3, "x", i4, ", requested surface size: ");
        g63.o(n, min, "x", min2, ", old surface size: ");
        n.append(i5);
        n.append("x");
        n.append(i6);
        logD(n.toString());
    ...
    public void onMeasure(int i, int i2) {
        ...
        logD(g63.h("onMeasure(). New size: ", measure.x, measure.y, "x"));
    }
