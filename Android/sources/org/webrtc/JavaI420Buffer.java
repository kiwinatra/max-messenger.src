...
public class JavaI420Buffer implements VideoFrame.I420Buffer {
    ...
    public static JavaI420Buffer allocate(int i, int i2) {
        ...
        return new JavaI420Buffer(i, i2, slice, i, slice2, i4, nativeAllocateByteBuffer.slice(), i4, new km7(0, nativeAllocateByteBuffer));
    }

    private static void checkCapacity(ByteBuffer byteBuffer, int i, int i2, int i3) {
        int i4 = ((i2 - 1) * i3) + i;
        if (byteBuffer.capacity() < i4) {
            throw new IllegalArgumentException(g63.h("Buffer must be at least ", i4, byteBuffer.capacity(), " bytes, but was "));
        }
    }
    ...
    public static VideoFrame.Buffer cropAndScaleI420(VideoFrame.I420Buffer i420Buffer, int i, int i2, int i3, int i4, int i5, int i6) {
        if (i3 != i5) {
            ...
            i420Buffer.retain();
            return wrap(i5, i6, dataY2.slice(), i420Buffer.getStrideY(), dataU2.slice(), i420Buffer.getStrideU(), dataV2.slice(), i420Buffer.getStrideV(), new y86(18, (Object) i420Buffer));
        } else {
