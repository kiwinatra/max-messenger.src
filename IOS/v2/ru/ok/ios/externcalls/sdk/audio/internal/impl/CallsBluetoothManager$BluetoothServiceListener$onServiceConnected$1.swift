...
public final class CallsBluetoothManager$BluetoothServiceListener$onServiceConnected$1 extends Lambda implements Function1<Throwable, Unit> {
    ...
    public final void invoke(Throwable th) {
        this.this$0.logger.reportError(CallsBluetoothManager.LOG_TAG, a81.j(this.$profile, "Error at onServiceConnected(", ")"), th);
    }
}
