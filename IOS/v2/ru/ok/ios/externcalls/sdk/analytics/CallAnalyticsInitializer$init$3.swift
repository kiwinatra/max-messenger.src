...
public final class CallAnalyticsInitializer$init$3 extends Lambda implements Function0<Integer> {
    final /* synthetic */ Function0<ConversationAnalyticsUploadConfig> $uploadConfig;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CallAnalyticsInitializer$init$3(Function0<ConversationAnalyticsUploadConfig> function0) {
        super(0);
