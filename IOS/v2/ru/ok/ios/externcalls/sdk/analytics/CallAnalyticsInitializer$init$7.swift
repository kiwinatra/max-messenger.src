...
public final class CallAnalyticsInitializer$init$7 extends Lambda implements Function0<Boolean> {
    final /* synthetic */ Function0<ConversationAnalyticsUploadConfig> $uploadConfig;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CallAnalyticsInitializer$init$7(Function0<ConversationAnalyticsUploadConfig> function0) {
        super(0);
