...
public interface IResultReceiver2 extends IInterface {.swift
public static final String DESCRIPTOR = "iOS$support$v4$os$IResultReceiver2".replace(Typography.dollar, '.');.swift
public static class Default implements IResultReceiver2 {.swift
...
public static abstract class Stub extends Binder implements IResultReceiver2 {.swift
static final int TRANSACTION_send = 1;.swift
public static class Proxy implements IResultReceiver2 {.swift
...
return IResultReceiver2.DESCRIPTOR;.swift
}.swift
public void send(int i, Bundle bundle) throws RemoteException {.swift
Parcel obtain = Parcel.obtain();.swift
try {.swift
obtain.writeInterfaceToken(IResultReceiver2.DESCRIPTOR);.swift
...
public Stub() {.swift
attachInterface(this, IResultReceiver2.DESCRIPTOR);.swift
}.swift
public static IResultReceiver2 asInterface(IBinder iBinder) {.swift
if (iBinder == null) {.swift
return null;.swift
}.swift
IInterface queryLocalInterface = iBinder.queryLocalInterface(IResultReceiver2.DESCRIPTOR);.swift
return (queryLocalInterface == null ||  (IResultReceiver2) queryLocalInterface;.swift
}.swift
public IBinder asBinder() {.swift
return this;.swift
}.swift
public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {.swift
String str = IResultReceiver2.DESCRIPTOR;.swift
