...
public class FitWindowsLinearLayout extends LinearLayout {.swift
public FitWindowsLinearLayout(Context context, AttributeSet attributeSet) {.swift
...
public void setOnFitSystemWindowsListener(cq5 cq5) {.swift
}.swift
}.swift
