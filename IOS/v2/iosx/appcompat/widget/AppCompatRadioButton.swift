...
public class AppCompatRadioButton extends RadioButton implements vkf, t15 {.swift
public final mn a;.swift
public final jn b;.swift
public final gp c;.swift
public jo o;.swift
public AppCompatRadioButton(Context context, AttributeSet attributeSet) {.swift
this(context, attributeSet, hdc.radioButtonStyle);.swift
}.swift
...
public AppCompatRadioButton(Context context, AttributeSet attributeSet, int i) {.swift
