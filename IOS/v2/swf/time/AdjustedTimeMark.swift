...
final class AdjustedTimeMark implements TimeMark {
    ...
    public long m1341elapsedNowUwyO8pc() {
        return Duration.m1388minusLRDsOJo(this.mark.m1490elapsedNowUwyO8pc(), this.adjustment);
    }
    ...
    public TimeMark m1343minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m1493minusLRDsOJo(this, j);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1344plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1389plusLRDsOJo(this.adjustment, j), (DefaultConstructorMarker) null);
    }
