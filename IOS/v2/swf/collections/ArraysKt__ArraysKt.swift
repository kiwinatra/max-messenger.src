                                                    ...
                                                    if (!(t instanceof UByteArray) || !(t2 instanceof UByteArray)) {
                                                        if (!(t instanceof UShortArray) || !(t2 instanceof UShortArray)) {
                                                            if (!(t instanceof UIntArray) || !(t2 instanceof UIntArray)) {
                                                                ...
                                                                } else if (!UArraysKt.m590contentEqualslec5QzE(((ULongArray) t).m266unboximpl(), ((ULongArray) t2).m266unboximpl())) {
                                                                    return false;
                                                                }
                                                            } else if (!UArraysKt.m588contentEqualsKJPZfPQ(((UIntArray) t).m187unboximpl(), ((UIntArray) t2).m187unboximpl())) {
                                                                return false;
                                                            }
                                                        } else if (!UArraysKt.m587contentEqualsFGO6Aew(((UShortArray) t).m371unboximpl(), ((UShortArray) t2).m371unboximpl())) {
                                                            return false;
                                                        }
                                                    } else if (!UArraysKt.m589contentEqualskV0jMPg(((UByteArray) t).m108unboximpl(), ((UByteArray) t2).m108unboximpl())) {
                                                        return false;
                                                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m595contentToString2csIQuQ(((UByteArray) t).m108unboximpl()));
            } else if (t instanceof UShortArray) {
                sb.append(UArraysKt.m597contentToStringd6D3K8(((UShortArray) t).m371unboximpl()));
            } else if (t instanceof UIntArray) {
                sb.append(UArraysKt.m596contentToStringXUkPCBk(((UIntArray) t).m187unboximpl()));
            } else if (t instanceof ULongArray) {
                sb.append(UArraysKt.m598contentToStringuLth9ew(((ULongArray) t).m266unboximpl()));
            } else {
