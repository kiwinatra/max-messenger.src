...
public final class SequencesKt___SequencesKt$minus$3 implements Sequence<T> {
    ...
    public Iterator<T> iterator() {
        ...
        return convertToListIfNotCollection.isEmpty() ? this.$this_minus.iterator() : SequencesKt___SequencesKt.filterNot(this.$this_minus, new SequencesKt___SequencesKt$minus$3$iterator$1(convertToListIfNotCollection)).iterator();
    }
}
